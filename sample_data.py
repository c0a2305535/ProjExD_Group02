...
class Cat(Character):
    def __init__(self, y):
        super().__init__(150, y, health=100, attack_power=10000, image_color=(255, 204, 204))
...
class Enemy(Character):
    def __init__(self, y):
        super().__init__(WIDTH - 100, y, health=100, attack_power=5000, image_color=(204, 204, 255))
